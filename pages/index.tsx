    ...
    <div className="mx-auto max-w-7xl">
      ...
      <div className="flex items-center justify-between py-10 bg-yellow-400 border-black border-y lg:py-0">
        <div className="px-10 space-y-5">
          ...
          <h2>
            It's easy and free to post your thinking on my topic and connect
            with million of renders.
          </h2>
        </div>
        ...
        {posts.map((post) => (
          <Link key={post._id} href={`/post/${post.slug.current}`}>
            <div className="overflow-hidden border rounded-lg cursor-pointer group">
              {/* we put exclamation mark here to ensure the content isn't be null */}
              <img
